...
(65, (SELECT course_instance_id FROM course_instance ci JOIN course_layout cl ON ci.course_layout_id=cl.course_layout_id WHERE cl.course_code='IV1351' AND ci.study_period='P1' AND ci.study_year=2025 LIMIT 1), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Lecture')),
...
(64, (SELECT course_instance_id FROM course_instance ci JOIN course_layout cl ON ci.course_layout_id=cl.course_layout_id WHERE cl.course_code='IV1351' AND ci.study_period='P1' AND ci.study_year=2025 LIMIT 1), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Other')),
...
(60, (SELECT course_instance_id FROM course_instance ci JOIN course_layout cl ON ci.course_layout_id=cl.course_layout_id WHERE cl.course_code='IX1500' AND ci.study_period='P1' AND ci.study_year=2025 LIMIT 1), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Other')),
...
(61, (SELECT course_instance_id FROM course_instance ci JOIN course_layout cl ON ci.course_layout_id=cl.course_layout_id WHERE cl.course_code='IX1500' AND ci.study_period='P1' AND ci.study_year=2025 LIMIT 1), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Tutorial')),
...
(60, (SELECT course_instance_id FROM course_instance ci JOIN course_layout cl ON ci.course_layout_id=cl.course_layout_id WHERE cl.course_code='MA1000' AND ci.study_period='P3' AND ci.study_year=2026 LIMIT 1), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Lecture')),
...
(60, (SELECT course_instance_id FROM course_instance ci JOIN course_layout cl ON ci.course_layout_id=cl.course_layout_id WHERE cl.course_code='CS3000' AND ci.study_period='P2' AND ci.study_year=2025 LIMIT 1), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Lecture')),
(60, (SELECT course_instance_id FROM course_instance ci JOIN course_layout cl ON ci.course_layout_id=cl.course_layout_id WHERE cl.course_code='CS3000' AND ci.study_period='P2' AND ci.study_year=2025 LIMIT 1), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Seminar')),
...
(60, (SELECT course_instance_id FROM course_instance ci JOIN course_layout cl ON ci.course_layout_id=cl.course_layout_id WHERE cl.course_code='EN1050' AND ci.study_period='P1' AND ci.study_year=2025 LIMIT 1), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Lecture')),
...
(63, (SELECT course_instance_id FROM course_instance ci JOIN course_layout cl ON ci.course_layout_id=cl.course_layout_id WHERE cl.course_code='AI1010' AND ci.study_period='P4' AND ci.study_year=2026 LIMIT 1), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Lecture')),
...
(60, (SELECT course_instance_id FROM course_instance ci JOIN course_layout cl ON ci.course_layout_id=cl.course_layout_id WHERE cl.course_code='SW3000' AND ci.study_period='P1' AND ci.study_year=2025 LIMIT 1), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Lecture')),
...
(60, (SELECT course_instance_id FROM course_instance ci JOIN course_layout cl ON ci.course_layout_id=cl.course_layout_id WHERE cl.course_code='DP2100' AND ci.study_period='P2' AND ci.study_year=2025 LIMIT 1), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Lecture')),
...
(60, (SELECT course_instance_id FROM course_instance ci JOIN course_layout cl ON ci.course_layout_id=cl.course_layout_id WHERE cl.course_code='IV1351' AND ci.study_period='P2' AND ci.study_year=2025 LIMIT 1), (SELECT teaching_activity_id FROM teaching_activity WHERE activity_name='Lecture')),
