...
ALTER TABLE employee ADD CONSTRAINT FK_employee_1 FOREIGN KEY (job_id) REFERENCES job_title (job_id);
ALTER TABLE employee ADD CONSTRAINT FK_employee_2 FOREIGN KEY (manager_id) REFERENCES employee (employee_id);
...
ALTER TABLE allocation ADD CONSTRAINT FK_allocation_0 FOREIGN KEY (planned_activity_id) REFERENCES planned_activity (planned_activity_id);
ALTER TABLE allocation ADD CONSTRAINT FK_allocation_1 FOREIGN KEY (employee_id) REFERENCES employee (employee_id);